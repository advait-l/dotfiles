...
require('lazy').setup({
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      -- Special jdtls config: each project needs its own workspace data directory.
      -- jdtls stores per-project indexes/caches there; sharing a single dir across
      -- projects causes conflicts, so we derive a unique path from the project root.
      vim.lsp.config('jdtls', {
        -- Tell jdtls where its installation lives (managed by Mason)
        cmd = {
          'jdtls',
          '-data',
        ...
        init_options = {
          extendedClientCapabilities = {
            ...
            skipTextDocumentBindingCapability = true,
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      require('kanagawa').setup {
        ...
        overrides = function(colors)
          ...
          return {
            ...
            FloatTitle = { bg = '#151515' },
            LineNr = { bg = '#151515' },
            SignColumn = { bg = '#151515' },
            EndOfBuffer = { bg = '#151515' },
            LineNrAbove = { bg = '#151515' },
            LineNrBelow = { bg = '#151515' },
            ...
            StatusLineNC = { bg = '#151515' },
            TabLine = { bg = '#151515' },
            TabLineFill = { bg = '#151515' },
            NvimTreeNormal = { bg = '#131313' },
            NvimTreeNormalNC = { bg = '#131313' },
            NvimTreeEndOfBuffer = { bg = '#131313' },
            NeoTreeNormal = { bg = '#131313' },
            NeoTreeNormalNC = { bg = '#131313' },
            NeoTreeEndOfBuffer = { bg = '#131313' },
            ['@type'] = { italic = false },
      ...
      vim.api.nvim_set_hl(0, 'IblScope', { fg = '#6b7285' })
    end,
  },
